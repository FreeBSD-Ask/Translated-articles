...
OpenBSD 假定用户具备丰富的计算机经验，其界面相对简约。您需要从其网站下载安装镜像，就像在下载 Linux 时一样，然后将其[解压到存储器](https://www.makeuseof.com/tag/extract-iso-files-linux/)中，并启动计算机。
...
如果您觉得在 Linux 上[开源和专有硬件驱动程序的支持](https://www.makeuseof.com/closed-source-vs-open-source-hardware-drivers/)令人沮丧，那么在[基于 BSD 的操作系统上](https://www.makeuseof.com/best-bsd-based-operating-systems/)，您的选择会更有限，因为至少在桌面领域，它们比 Linux 更为小众。
